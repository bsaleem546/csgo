           ...
           <!-- Container -->
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-cube"></i></span>Edit Case</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                        	<form method="post" action="{{ URL::to('/admin/case/update')}}" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm">
                                    <div class="row">
                                    		 @if ($errors->any())
	                                        ...
	                                        <div class="col-md-4">
		                                    		...
		                                    		{{ csrf_field() }}
		                                    		<input type="hidden" name="case_id" value="{{base64_encode($data->id)}}" />
		                                    		<input type="hidden" name="old_thumb" value="{{$data->thumbnail}}" />
		                                        	<div class="row">
			                                        	<div class="col-md-6">
													        <img id="skin-thumb" src="{{URL::to('/dist/web/assets/images/cases/'.$data->id.'-'.$data->thumbnail)}}" alt="your image" />
			                                        	...
			                                        	<div class="col-lg-12">
			                                        		<div class="row">
				                                        		<div class="col-md-12">
						                                            ...
						                                            <input type="text" placeholder="" class="form-control form-control-sm" name="label" value="{{$data->label}}" required>
						                                        </div>
				                                        	</div>
				                                        	<br>
				                                        	<div class="row">
				                                        		<div class="col-md-7">
						                                            ...
						                                            <input type="date" placeholder="" class="form-control form-control-sm" name="expiry" value="{{$data->expiry_date}}">
						                                        </div>
				                                        		<div class="col-md-5">
						                                        	<span class="label_span">Price</span><span class="required_span">*</span>
						                                            <input type="number" step="any" placeholder="" class="form-control form-control-sm" name="price" value="{{$data->price}}" required>
						                                        </div>
						                                    </div>
						                                    <br>
						                                    <div class="row">
						                                    	<div class="col-md-12">
		                                                            ...
		                                                            <div class="block-border">
		                                                                <div class="custom-control custom-radio block">
		                                                                    <input type="radio" id="customRadio1" name="category" value="1" class="custom-control-input" {{$data->category_id == '1' ? 'checked' : ''}}>
		                                                                    <label class="custom-control-label" for="customRadio1">Featured</label>
		                                                                </div>
		                                                                <div class="custom-control custom-radio block">
		                                                                    <input type="radio" id="customRadio2" name="category" value="2" class="custom-control-input" {{$data->category_id == '2' ? 'checked' : ''}}>
		                                                                    <label class="custom-control-label" for="customRadio2">Official</label>
		                                                                </div>
		                                                                <div class="custom-control custom-radio block">
		                                                                    <input type="radio" id="customRadio3" name="category" value="3" class="custom-control-input" {{$data->category_id == '3' ? 'checked' : ''}}>
	                                    	...
	                                    	<div class="col-md-8" style="background-color: #eaeaea;">
	                                    		<div class="row">
	                                    			...
	                                    			<div class="col-lg-4">
	                                    				<input type="hidden" id="totalOd" value="{{$totalodds}}">
	                                    				<h6>Total Odds: <span id="totalOdds">{{$totalodds}}</span></h6>
	                                    		...
	                                    		<div class="row row-bg">
	                                    			<div class="col-lg-12">
		                                    			<table class="skin-table">
		                                    				...
		                                    				<tbody id="skinitem">
			                                    				@php $it=1; @endphp
			                                    				@foreach($data->detail as $key => $dd)
    			                                    				<tr>
                                                                    	<td>
                                                                    		<select class="form-control form-control-sm select2" name="skinid[]" required>
                                                                        		<option value="">Select</option>
                                                                        		@foreach($skins as $key => $skin)
                                                                        			<option value="{{$skin->id}}" {{$dd->skin_id == $skin->id ? 'selected' : ''}}>{{$skin->hash_name.' ('.$skin->exterior.')'}}</option>
                                                                        		@endforeach
                                                                        	</select>
                                                                    	</td>
                                                                    	<td>
                                                                    		<input type="number" name="sods[]" class="form-control form-control-sm skinOdd" step="any" value="{{$dd->odds}}" required="">
                                                                    	</td>
                                                                    	<td>
                                                                    	    @if($it == 1)
                                                                    	        <button class="btn btn-success btn-sm" id="addbtn"><span class="fa fa-plus"></span></button>
                                                                    		@else
                                                                    		    <button class="btn btn-danger btn-sm delete"><span class="fa fa-minus"></span></button>
                                                                    		@endif
                                                                    	</td>
                                                                    </tr>
                                                                    @php $it++; @endphp
