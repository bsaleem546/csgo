        ...
        var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("wdig").innerHTML +=
                    this.responseText;
                }
            };
            xhttp.open("GET", host+"admin/withdraw/checkUpdate", true);
            xhttp.send();
            
        var xhttp = new XMLHttpRequest();
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("drig").innerHTML +=
                    this.responseText;
                }
            };
            xhttp.open("GET", host+"admin/deposit/checkUpdate", true);
            xhttp.send();
